...
& {
    ...
    Set-VividLifeProperty { $PSStyle.Formatting.FormatAccent = $PSStyle.Foreground.FromRgb(252, 165, 165) }
    Set-VividLifeProperty { $PSStyle.Formatting.TableHeader = $PSStyle.Bold + $PSStyle.Foreground.FromRgb(252, 165, 165) }
    Set-VividLifeProperty { $PSStyle.Formatting.CustomTableHeaderLabel = $PSStyle.Bold + $PSStyle.Foreground.FromRgb(252, 165, 165) }
